...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/rates/rates.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RatesCalculator; });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js");
/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _calculator_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../calculator.js */ "./src/calculator.js");
/* harmony import */ var financial__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! financial */ "./node_modules/financial/dist/financial.esm.js");
...
var RatesCalculator = /*#__PURE__*/function () {
  function RatesCalculator(formEl) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, RatesCalculator);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(RatesCalculator, [{
    key: "payment",
    value: function payment(rate) {
      var result = Object(financial__WEBPACK_IMPORTED_MODULE_3__["pmt"])(rate / 12, 12 * this.term, this.amount);
      return result * -1;
    }
  }, {
    key: "generateTableHead",
    ...
    value: function response(elm) {
      ...
      var heads = [__('Rate', 'mortgage'), __('Monthly payment', 'mortgage'), __('Interests', 'mortgage'), __('Total', 'mortgage')];
      var count = [0, 1, 2, 3, 4];
      var data = [];
      count.forEach(function (y) {
        var rate = _this.rate + _this.increment * y;
        data.push({
          rate: (rate * 100).toFixed(2) + '<small>%</small>',
          recurring: _this.formatNumber(_this.payment(rate)),
          interests: _this.formatNumber(_this.payment(rate) * 12 * _this.term - _this.amount),
          total: _this.formatNumber(_this.payment(rate) * 12 * _this.term)
        });
      }); // reset table
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _calculator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./calculator.js */ "./src/rates/calculator.js");
