...
var Calculator = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Calculator, [{
    key: "payment",
    value: function payment(term) {
      var result = Object(financial__WEBPACK_IMPORTED_MODULE_3__["pmt"])(this.rate / 12, 12 * term, this.amount);
      return result * -1;
    }
  }, {
    ...
    value: function response(elm) {
      ...
      var heads = [__('Duration', 'mortgage'), __('Monthly payment', 'mortgage'), __('Interests', 'mortgage'), __('Total', 'mortgage')];
      var terms = [10, 15, 20, 25, 30];
      var data = [];
      terms.forEach(function (y) {
        data.push(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({
          years: y + __(' Years', 'mortgage'),
          recurring: _this.formatNumber(_this.payment(y)),
          interests: _this.formatNumber(_this.payment(y) * 12 * y - _this.amount),
          total: _this.formatNumber(_this.payment(y) * 12 * y)
        }, "interests", _this.formatNumber(_this.payment(y) * 12 * y - _this.amount)));
      }); // reset table
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _calculator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./calculator.js */ "./src/duration/calculator.js");
